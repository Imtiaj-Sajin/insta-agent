...
{/* save button */}
      ...
      >
        ...
        {/* Main Details Card */}
        <div id="dc_main" className="detail-card" style={{ top: "20%", left: "20px"}}>
          ...
          <div style={{background:"#fff",padding:"8px",color:"var(--navbar-text-color)",borderRadius:"8px"}}>
                <p style={{borderBottom: ".5px solid #ddd", margin:"8px 0px 8px"}}><strong>Post ID:</strong> {post_id}  ({auto_id})</p>
                <p  style={{margin:"8px 0px 8px"}}>
                  <strong>Type:</strong>{" "}
        ...
        <div id="dc_keywords" className="detail-card" style={{ top: "5%", left: "30%" ,maxHeight:"500px"}}>
        ...
        {(auto_type === 2 || auto_type === 3) && (
          <div id="dc_dm" className="detail-card" style={{ top: "30%", left: "50%",maxHeight:"600px" }}>
